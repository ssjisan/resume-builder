...
export default function References() {
  ...
  const [referentCompany, setReferentCompany] = useState("");
  const handleReferentName = (e) => {
    setReferentName(e.target.value);
  };
            ...
            <Grid container rowSpacing={3} columnSpacing={{ xs: 2, md: 4 }}>
              ...
              <Grid item xs={12} md={6}>
                ...
                <TextField
                  variant="filled"
                  size="small"
                  name="Referent Company"
                  value={referentCompany}
                  fullWidth
                  hiddenLabel
                  onChange={handleReferentCompany}
                />
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography
